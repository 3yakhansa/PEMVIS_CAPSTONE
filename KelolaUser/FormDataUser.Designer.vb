...
Partial Class FormDataUser
	...
	Private Sub InitializeComponent()
		...
		' txtCariUser
		' 
		txtCariUser.BackColor = Color.FromArgb(CByte(184), CByte(213), CByte(218))
		txtCariUser.Location = New Point(12, 270)
		txtCariUser.Name = "txtCariUser"
		txtCariUser.PlaceholderText = "Cari username atau NIM Referensi..."
		txtCariUser.Size = New Size(774, 27)
		txtCariUser.TabIndex = 2
		' 
		' cmbLevel
		' 
		...
		PerformLayout()
	End Sub
	Friend WithEvents txtCariUser As TextBox
